...
local primary = "rgb(85e9e1)"
local surface = "rgb(152728)"
local on_surface = "rgb(f2f3f3)"
local secondary = "rgb(8cbfe2)"
local on_secondary = "rgb(182524)"
local error = "rgb(fd4663)"
local on_error = "rgb(182524)"
